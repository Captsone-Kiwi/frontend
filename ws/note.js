...
function spacebar(event) {
  ...
  const leftChairGroup = runtimeScene
    .getObjects("couch02")
    .concat(runtimeScene.getObjects("chair_kitchen02"));
  const rightChairGroup = runtimeScene
    .getObjects("chair_kitchen")
    .concat(runtimeScene.getObjects("couch_blue02"))
    .concat(runtimeScene.getObjects("couch01"));
  const downChairGroup = runtimeScene
    .getObjects("toilet")
    .concat(runtimeScene.getObjects("couch_blue01"));
  const upChairGroup = runtimeScene
    .getObjects("makeup_chair01")
    .concat(runtimeScene.getObjects("makeup_chair02"))
    .concat(runtimeScene.getObjects("makeup_chair03"))
    .concat(runtimeScene.getObjects("couch_up"))
    .concat(runtimeScene.getObjects("chair_kitchen03"))
    .concat(runtimeScene.getObjects("chair_black"));
